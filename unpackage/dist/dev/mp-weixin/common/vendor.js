...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"yishop","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
exports.delLoading = delLoading;
exports.get = get;
exports.getLoading = getLoading;
exports.post = post;
exports.postLoading = postLoading;
exports.put = put;
exports.putLoading = putLoading;
var _config = _interopRequireDefault(__webpack_require__(/*! ./config */ 34));
function login() {
  uni.navigateTo({
...
function request(_ref) {
  var _ref$method = _ref.method,
    ...
    _ref$isShowLoading = _ref.isShowLoading,
    isShowLoading = _ref$isShowLoading === void 0 ? false : _ref$isShowLoading,
    _ref$isFirst = _ref.isFirst,
    isFirst = _ref$isFirst === void 0 ? true : _ref$isFirst,
    _ref$sucToast = _ref.sucToast,
    sucToast = _ref$sucToast === void 0 ? false : _ref$sucToast,
    _ref$errToast = _ref.errToast,
    errToast = _ref$errToast === void 0 ? true : _ref$errToast;
  var header = {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: "".concat(_config.default.api).concat(url),
      data: data,
      method: method,
      header: header,
...
var api = "".concat(host, "/api/");
var uploadImg = "".concat(host, "/common/upload");
var config = {
  host: host,
  api: api,
  uploadImg: uploadImg
...
exports.getImgAttr = getImgAttr;
exports.getNowFormatDate = getNowFormatDate;
exports.isEmpty = isEmpty;
exports.localImgs2webImgs = void 0;
...
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _fetch = __webpack_require__(/*! ./fetch */ 33);
var _config = _interopRequireDefault(__webpack_require__(/*! ./config */ 34));
/* eslint-disable */
 ...
 */
var photoArr = []; //图片数组
function choosePic(arr) {
  var _this = this;
  var maxLengthOne = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 9;
  uni.chooseImage({
    count: maxLength,
    success: function success(res) {
      var fileLength = res.tempFilePaths.length;
      _this.imgUpload(res.tempFilePaths, 0, fileLength);
    }
  });
}
...
var localImgs2webImgs = function localImgs2webImgs() {
  var localImgs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var url = _config.default.uploadImg;
  showLoading('上传中...');
  var promiseList = localImgs.map(function (item) {
    return new Promise(function (resolve) {
      uni.uploadFile({
        url: url,
        filePath: item,
  ...
  var result = Promise.all(promiseList).then(function (res) {
    uni.hideLoading();
    return res;
...
exports.localImgs2webImgs = localImgs2webImgs;
...
function showModal(title, content, sucCal, canCal) {
...
function getImgAttr(url) {
  if (url) {
    return "".concat(_config.default.host).concat(url);
  }
}
/**
	 * js 时间戳的转换（自定义格式）
...
/* 64 */
/*!**************************************************!*\
  !*** E:/gzj/uni模板/components/uni-icons/icons.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
